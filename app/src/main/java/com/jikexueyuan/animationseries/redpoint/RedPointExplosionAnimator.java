 ...
 * 红点ExplosionAnimator
 */
public class RedPointExplosionAnimator extends ValueAnimator {
    ...
    private RedPointDragView mRedPointDragView;
    private Rect mRect;
    private Rect mInvalidateRect;

    public RedPointExplosionAnimator(RedPointDragView redPointDragView, Rect rect, Bitmap bitmap) {
        setFloatValues(0.0f, END_VALUE);
        setDuration(ANIM_DURATION);
        setInterpolator(DEFAULT_INTERPOLATOR);

        X = RedPointViewUtil.dp2px(redPointDragView.getContext(), 5);
        Y = RedPointViewUtil.dp2px(redPointDragView.getContext(), 20);
        V = RedPointViewUtil.dp2px(redPointDragView.getContext(), 2);
        W = RedPointViewUtil.dp2px(redPointDragView.getContext(), 1);

        mPaint = new Paint();
        mRedPointDragView = redPointDragView;
        mRect = rect;
    ...
    private void postInvalidate() {
        mRedPointDragView.postInvalidate(mInvalidateRect.left, mInvalidateRect.top, mInvalidateRect.right, mInvalidateRect.bottom);
    }
